...
class _InsumosScreenState extends State<InsumosScreen> {
  ...
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>(); // Formulario global
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Insumos', style: TextStyle(fontStyle: FontStyle.italic, color: Color.fromARGB(255, 0, 0, 0))
        ),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(insumo['nombre'], style: const TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 0, 0))), // Estilo del título
              subtitle: Text('Cantidad: ${insumo['cantidad']}, Unidad de Medida: ${insumo['unidadMedida']}', style: const TextStyle(color: Color.fromARGB(255, 0, 0, 0))), // Texto blanco
              trailing: Row(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    controller: _unidadMedidaController,
                    decoration: const InputDecoration(labelText: 'Unidad de Medida', labelStyle: TextStyle(color: Color.fromARGB(255, 0, 0, 0))), 
                    style: const TextStyle(color: Color.fromARGB(255, 0, 0, 0)), // Texto en blanco
                    validator: (value) {
                      if (value == null || value.isEmpty) {
